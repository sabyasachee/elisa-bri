    ...
    def __init__(self,
        ...
        for task_id in range(2):
            with vs.variable_scope('task' + str(task_id)):
                ...
                # Added by me
                num_tags = self.unary_scores.get_shape()[2].value
                transition_params = vs.get_variable("transitions", [num_tags, num_tags])
                
                # log_likelihood, transition_params = tf.contrib.crf.crf_log_likelihood(self.unary_scores, self.labels, self.sentence_lens)
